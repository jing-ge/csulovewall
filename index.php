...
<body class="bg-warning">
	<div class="container">
		<div class="nav navbar-inverse navbar-fixed-bottom text-center upanddown" id="header" style="background-color:pink;">

    		<h3 class="font-weight" style="color: white;"><span class="glyphicon glyphicon-heart xin"></span><span class="glyphicon glyphicon-heart-empty xin"></span><span class="glyphicon glyphicon-heart xin"></span>中南大学表白墙<span class="glyphicon glyphicon-heart xin"></span><span class="glyphicon glyphicon-heart-empty xin"></span><span class="glyphicon glyphicon-heart xin"></span></h3>
    	</div>
    	...
    	<div class="jumbotron yy" id="biaodan" style="padding-top: 60px;">
    		<form role="form" id="biaodan" action="form.php" method="post">
    			<div class="form-group">
    			<h3 class=" text-center" style="color:pink;"><span class="glyphicon glyphicon-heart-empty neixin"></span>大声说出你的爱~~~<span class="glyphicon glyphicon-heart-empty neixin"></span></h3>
    			<hr>
    			<h5 class="text-center text-info">5月1日表白墙正式上线喽~~~</h5>	
    			<h5 class="text-center text-info">在这里你可以留下任何你想说却又找不到人说的话，墙墙听你说~~</h5>
    			<h6 class="text-center text-info">更多信息请看页末——关于墙墙</h6>
    				<label class="label label-primary">&nbsp;昵&nbsp;&nbsp; 称：&nbsp; </label>
    				<input type="text" class="form-control" placeholder="CSU匿名爱恋者" name="name">
    			</div>
    			<div class="form-group">
    				<label class="label label-primary ">表白内容:</label>
    				<input type="text" class="form-control" name="content" placeholder="I LOVE CSU">
    			</div>
    			<div class="form-group text-right"> 
				<input type="submit" value="我要上墙表白" class="btn btn-success " >
				<input type="reset" value="还是再想想吧" class="btn btn-danger " >
			</div>
    		</form>
    	</div>
    	<div class="jumbotron shua yy">
    	...
    	<?php foreach ($data as  $v) { 
    			$sql2 = "select count(*) from comments where lid=".$v['id'];
    			$count = $mysql->getRow($sql2)['count(*)'];
    		?>
    	<div class="jumbotron  neirong yy" >
    		<div class="media">
			  ...
			  <div class="text-right"><a href="index.php?id=<?=$v['id']?>">已有<?=$count?>条评论&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary">查看详情</button></a></div>
			</div>
    	</div>
<?php } ?>
		...
		<p class="text-center">错过了就不必再寻找，总会有新表白的出现！</p>    			
    		<div class="text-right inline">
    			<a href="index.php"><button class="btn btn-info btn-block"><span class="glyphicon glyphicon-refresh"></span>点击刷新</button></a>	
    		</div>
    		<hr>
        ...
        <div role="dialog" class="modal fade bs-example-modal-sm" id="xmm">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button class="close" data-dismiss="modal"><span>&times</span></button>
						<h4 class="modal-title text-center">嘘~~~告诉你一个小秘密</h4>
