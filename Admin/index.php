<?php 
	...
	$mysql =new Mysql();
	$sql="select * from lovecontent order by id desc limit 100";
...
<body class="bg-warning">
	<div class="container">
    	...
    	<div class="jumbotron shua yy" style="padding-top: 30px;">
    	...
    	<div class="jumbotron  neirong yy" >
    		<div class="media">
			  ...
			  <div class="text-right"><a href="index.php?id=<?=$v['id']."&pwd=".$pwd?>">已有<?=$count?>条评论&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary">查看详情</button></a>&nbsp;&nbsp;&nbsp;<a href="del.php?<?="pwd=".$pwd."&id=".$v['id']?>""><button class="btn btn-danger">&nbsp;&nbsp;&nbsp;删除&nbsp;&nbsp;&nbsp;</button></a></div>
			</div>
    	</div>
<?php } ?>
